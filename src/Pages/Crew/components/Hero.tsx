...
export function Hero({crew}:type){
    ...
    return(
        <section className="w-full text-white grid gap-16 md:mt-5">
            ...
            <div className='grid gap-10 md:flex md:place-content-start'>
                <div className='grid gap-7 md:place-content-center md:content-around md:h-5/6'>
                    <div className="w-[90%] mx-auto grid gap-7 md:w-2/3 md:content-center">
                        <div className="text-center grid gap-2 font-bellefair md:text-left">
                        ...
                        <p className="text-center font-barlow text-md text-Blue300 md:text-left">
                            {crew[currentCrew].bio}
                        </p>
                    </div>

                    <div className="w-1/2 mx-auto flex justify-center gap-5 md:justify-start md:w-2/3">
                ...
                <div className='w-5/6 mx-auto mb-10  place-self-start'>
